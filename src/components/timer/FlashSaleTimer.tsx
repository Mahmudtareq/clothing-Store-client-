...
const FlashSaleTimer = () => {
  ...
  const dateTimeAfterOnedays = NOW_IN_MS + THIRTY_MINUTES_IN_MS;
  return (
    <div>
      <div className="my-3">
        <h4 className="font-medium text-zinc-700 text-lg dark:text-white">
          Don't Miss Out! Our Flash Sale Ends in Just One Day!
        </h4>
        <p className="text-justify font-normal dark:text-white">
